...
<h1 class="text-center mt-4">Borrar un usuario administrativo</h1>
<div class="card p-4 bg-light">
  ...
  <form action="<?php print RUTA; ?>admonUsuarios/baja/" method="POST">
    ...
    <div class="form-group text-left">
      ...
      placeholder="Escribe tu usuario (tu correo electrónico)" disabled
      value="<?php 
    ...
    <div class="form-group text-left">
      ...
      <a href="<?php print RUTA;?>admonUsuarios" class="btn btn-info">Cancelar y Regresar</a>
      <p>
          Una vez que los datos son borrados, no se pueden recuperar el registro.
      </p>
    </div>
  </form>
</div><!--card-->
