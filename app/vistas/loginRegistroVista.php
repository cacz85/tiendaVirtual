...
<form action="<?php print RUTA; ?>login/registro/" method="POST">
    ...
    <div class="form-group text-left">
      ...
      <input type="text" name="colonia" id="colonia" class="form-control" placeholder="Escriba su colonia" required value='<?php isset($datos["data"]["colonia"])? print $datos["data"]["colonia"]:""; ?>'/>
    </div>
